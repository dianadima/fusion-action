function [] = fmri_decode(glmpath,respath,sub_idx)
...
for d = 1:2
    ...
    for isub = 1:numel(sub_idx)
        ...
        decmap = run_searchlight_decoding(sub_res,sub_des,thresh);
        decoding_map(isub,:,:,:) = decmap;
        clear decmap

    end

    save(fullfile(respath,'decode',['decoding-' dtype '.mat']),'decoding_map')
